...
router.get('/getAllConfigMenus', auth(['superAdmin']), GetAllConfigMenus);
router.put('/editConfigMenus', auth(['superAdmin']), EditConfigMenus);
router.get('/getDashboardMenu', auth(), GetDashboardMenu);
