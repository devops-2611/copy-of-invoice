        ...
        Cell: ({ cell, row }) => (
          ...
          >
            {cell.getValue<string>() +
              " " +
              row.original?.customerArea +
              " " +
              row?.original?.customerPost}
          </Box>
        ),
      },
      // {
      //   accessorKey: "personalDetails.area",
      //   header: "Customer Area",
      //   enableSorting: false,
      //   maxSize: 50,
      // },
      // {
      //   accessorKey: "personalDetails.post",
      //   header: "Customer Post",
      //   enableSorting: false,
      //   maxSize: 50,
      // },
      {
        ...
        enableSorting: false,
        accessorFn: (originalRow) => new Date(originalRow?.customerDOB),
        Cell: ({ cell }) => {
